...
public class CameraController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        translation += new Vector3(Input.GetAxis("Horizontal"), 0, Input.GetAxis("Vertical")) * ArrowsSpeed;
        ...
        if ((LevelArea / 2 - desiredPosition.x) < -(LevelArea / 2 - 100) || (LevelArea / 2 - 100) < (LevelArea/2 - desiredPosition.x))
        {
            translation.x = 0;
        }
        ...
        if ((LevelArea / 2 - desiredPosition.z) < -(LevelArea / 2 - 100) || (LevelArea / 2 + 35) < (LevelArea / 2 - desiredPosition.z))
        {
            translation.z = 0;
        }
